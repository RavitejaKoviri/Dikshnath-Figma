...
//   const [itemGroups, setItemGroups] = useState(getItemGroups());
...
//         <div className="absolute inset-y-0 left-0 flex items-center justify-start md:justify-start lg:hidden">
//           <button
//             onClick={prevSlide}
//             className="p-2 rounded-full bg-black/50 text-white hover:bg-black/75 transition-colors -ml-9"
//             aria-label="Previous slide"
//           >
//             <ChevronLeft size={24} />
//           </button>
//         </div>
//         <div className="absolute inset-y-0 right-0 flex items-center justify-end md:justify-end lg:hidden">
//           <button
//             onClick={nextSlide}
//             className="p-2 rounded-full bg-black/50 text-white hover:bg-black/75 transition-colors -mr-9"
...
//           <button
//             onClick={prevSlide}
//             className="p-2 rounded-full bg-black/50 text-white hover:bg-black/75 transition-colors -ml-7"
//             aria-label="Previous slide"
//           >
//             <ChevronLeft size={24} />
//           </button>
...
//           <button
//             onClick={nextSlide}
//             className="p-2 rounded-full bg-black/50 text-white hover:bg-black/75 transition-colors -mr-7"
//             aria-label="Next slide"
//           >
//             <ChevronRight size={24} />
//           </button>
